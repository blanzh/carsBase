# База данных автомобилей JSON и CSV
...
### Обновление от 2021-2-2 13:45:37
|#|name|id|group|
|---|---|---|---|
...
Марка -> Модель -> Название поколения и/или годы выпуска -> Кузов -> Модификация (Объем дв., коробка передачь, мощность, топливо, id)
